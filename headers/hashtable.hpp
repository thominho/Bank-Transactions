...
public:
	...
	int dfs(node *t,int *path,int &csize,int &maxsize,int id1);//for command connection
	int dfs2(node::tran *t,int* path2,int &csize2,int &maxsize2,int &cdepth,int depth,int &sum,int &found,int id1);//for command traceflow
	int dfs3(node::tran *t,int *path,int* path2,int &csize1,int &csize2,int &maxsize,int &maxsize2,int &cdepth,int &found,int id1);//for command allcircles
};
