...
int size=15;
int flag=0;
	if(argc==1){//reading arguments if less than 2 too few arguments
	...
	if(flag==0){//bucket size is crucial for this excersize
	...
	if(fp!=NULL){
		...
		cout << "conn N1 N2" << endl;//done
		cout << "allcircles N" << endl;//done
		cout << "traceflow N I" << endl;//done
		cout << "bye" << endl;//done
